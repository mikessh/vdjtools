...
public class MaxClonotypeAggregatorFactory implements ClonotypeAggregatorFactory<MaxClonotypeAggregator> {
    @Override
    public MaxClonotypeAggregator create(Clonotype clonotype) {
        return new MaxClonotypeAggregator(clonotype.getFreq());
    }

    @Override
    public MaxClonotypeAggregator create() {
        return new MaxClonotypeAggregator();
    }
}
